    ...
    const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        try {
            ...
            if (isLogin) {
                ...
                dispatch(
                    openSnackbar({ message: 'Logged in successfully!', type: 'success' })
                );
                navigate('/dashboard');
            } else {
                ...
                await dispatch(signupUser(formattedValues)).unwrap();
                dispatch(
                    openSnackbar({
            ...
            <form onSubmit={handleSubmit}>
                ...
                <div className="space-y-4 mt-4">
                    ...
                    <button
                        ...
                        className="w-full bg-[#D9D9D9] text-black py-2 px-2
